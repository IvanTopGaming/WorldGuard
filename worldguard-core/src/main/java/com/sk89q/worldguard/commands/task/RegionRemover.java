            ...
            for (ProtectedRegion test : manager.getRegions().values()) {
                ...
                if (parent != null && parent.equals(region)) {
                    throw new CommandException(
                            "Регион '" + region.getId() + "' содержит дочерние регионы. Используйте -f для принудительного удаления дочерних регионов или -u для удаления родителя у этих дочерних регионов.");
                }
            }
